...
<http://example.org/dataset/One> dcterms:conformsTo <http://example.org/profile/Profile_C> ;

<http://example.org/dataset/Two> dcterms:conformsTo <http://example.org/profile/Profile_B> ;
